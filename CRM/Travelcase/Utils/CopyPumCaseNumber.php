...
class CRM_Travelcase_Utils_CopyPumCaseNumber{
  ...
  protected static function updatePumCaseNumber($entityID, $case_number) {
    ...
    if ($dao->fetch()) {
      ...
      2 => array((string) $case_number['country'], 'String'),
      3 => array((string) $case_number['type'], 'String'),
      ...
      CRM_Core_DAO::executeQuery($sql, array(
        ...
        3 => array((string) $case_number['country'], 'String'),
        4 => array((string) $case_number['type'], 'String'),
      ));
    }
  }
